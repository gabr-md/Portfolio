...
Antes de prosseguir para a análise descritiva, seria necessário fazer uma análise de dados faltantes (missing) e outliers (anomalias) porém, é dito na descrição da base de dados que não há dados faltantes ou qualquer anomalia.
